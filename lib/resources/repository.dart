...
class Repository {
  ...
  Future<void> saveMostRecentKingdom(List<Card> cards) async => await prefs.saveMostRecentKingdom(cards);
  Future<List<Card>> loadMostRecentKingdom() async => await prefs.getMostRecentKingdom();
